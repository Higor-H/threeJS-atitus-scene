...
/**
 * Controle de voo livre pela cena usando teclado.
 *
 * Teclas:
 *   W / ↑  — avançar
 *   S / ↓  — recuar
 *   A / ←  — deslocar para esquerda (strafe)
 *   D / →  — deslocar para direita (strafe)
 *   E / PageUp    — subir
 *   Q / PageDown  — descer
 *   Shift         — turbo (velocidade 3×)
 *
 * Use em conjunto com OrbitControls para controle do olhar com o mouse.
 */
class FlyCamera {
